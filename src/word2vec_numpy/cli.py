...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output", type=str, default="outputs/embeddings.txt",
...
def main(argv: list[str] | None = None) -> None:
    ...
    if vocab.size < 2:
        print("ERROR: vocabulary too small to train. Use a larger corpus or lower --min-count.",
              file=sys.stderr)
        sys.exit(1)
